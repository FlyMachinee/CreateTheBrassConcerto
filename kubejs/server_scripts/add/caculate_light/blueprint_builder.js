ServerEvents.recipes(event => {
  ...
  BlueprintBuilderRecipe(
    [
      ...
      BlueprintBuilderBarrelOut('{BlockEntityTag:{Items:[{Count:4b,Slot:0b,id:"design_decor:metal_support"},{Count:9b,Slot:1b,id:"design_decor:diagonal_girder"},{Count:4b,Slot:2b,id:"design_decor:andesite_floodlight"},{Count:9b,Slot:3b,id:"createaddition:straw"},{Count:15b,Slot:4b,id:"create:metal_girder"},{Count:4b,Slot:5b,id:"design_decor:industrial_iron_boiler_large"},{Count:16b,Slot:6b,id:"create:industrial_iron_block"},{Count:1b,Slot:7b,id:"railways:smokestack_oilburner"},{Count:4b,Slot:8b,id:"create:andesite_funnel"},{Count:6b,Slot:9b,id:"design_decor:diagonal_metal_support"},{Count:1b,Slot:10b,id:"design_decor:stepped_lever"},{Count:4b,Slot:11b,id:"design_decor:industrial_iron_boiler"},{Count:19b,Slot:12b,id:"design_decor:iron_railing"},{Count:9b,Slot:13b,id:"design_decor:ornate_grate"},{Count:9b,Slot:14b,id:"create:blaze_burner"}],id:"minecraft:barrel"},display:{Name:\'{"translate":"block.kubejs.alloy_furnace","italic":false}\'}}')
    ], "alloy_furnace", 120)
  BlueprintBuilderRecipe(
    [
