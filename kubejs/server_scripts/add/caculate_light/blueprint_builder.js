ServerEvents.recipes(event => {
  ...
  BlueprintBuilderRecipe(
    [
      ...
      BlueprintBuilderBarrelOut('{BlockEntityTag:{Items:[{Count:2b,Slot:0b,id:"create_things_and_misc:brass_brick_slab"},{Count:9b,Slot:1b,id:"create_connected:fluid_vessel"},{Count:2b,Slot:2b,id:"kubejs:carbon_electrode"},{Count:5b,Slot:3b,id:"design_decor:andesite_floodlight"},{Count:2b,Slot:4b,id:"design_decor:brass_boiler"},{Count:1b,Slot:5b,id:"design_decor:brass_boiler_large"},{Count:3b,Slot:6b,id:"design_decor:copper_boiler"},{Count:4b,Slot:7b,id:"design_decor:diagonal_metal_support"},{Count:4b,Slot:8b,id:"design_decor:copper_railing"},{Count:1b,Slot:9b,id:"design_decor:stepped_lever"},{Count:6b,Slot:10b,id:"create:mechanical_pump"},{Count:5b,Slot:11b,id:"create:smart_fluid_pipe"},{Count:6b,Slot:12b,id:"create:fluid_tank"},{Count:6b,Slot:13b,id:"create:item_drain"},{Count:27b,Slot:14b,id:"create:copper_casing"},{Count:9b,Slot:15b,id:"create:railway_casing"},{Count:2b,Slot:16b,id:"create:brass_funnel"},{Count:4b,Slot:17b,id:"createaddition:modular_accumulator"}],id:"minecraft:barrel"},display:{Name:\'{"translate":"block.kubejs.electrolytic_cell","italic":false}\'}}')
  ...
  BlueprintBuilderRecipe(
    [
      ...
      BlueprintBuilderBarrelOut('{BlockEntityTag:{Items:[{Count:1b,Slot:0b,id:"design_decor:stepped_lever"},{Count:1b,Slot:1b,id:"railways:smokestack_oilburner"},{Count:4b,Slot:2b,id:"create:brass_funnel"},{Count:54b,Slot:3b,id:"create:fluid_tank"},{Count:12b,Slot:4b,id:"create:copper_casing"},{Count:15b,Slot:5b,id:"design_decor:iron_railing"},{Count:2b,Slot:6b,id:"design_decor:copper_boiler"},{Count:15b,Slot:7b,id:"ad_astra:iron_pillar"},{Count:22b,Slot:8b,id:"create:industrial_iron_block"},{Count:9b,Slot:9b,id:"create:fluid_pipe"},{Count:48b,Slot:10b,id:"create:railway_casing"},{Count:9b,Slot:11b,id:"createaddition:straw"},{Count:9b,Slot:12b,id:"create:blaze_burner"},{Count:12b,Slot:13b,id:"design_decor:diagonal_girder"}],id:"minecraft:barrel"},display:{Name:\'{"translate":"block.kubejs.shaft_furnace","italic":false}\',Lore:[\'{"text":"II"}\']}}')
    ], "shaft_furnace", 120)
  BlueprintBuilderRecipe(
    [
      BlueprintBuilderBarrelIn(1),
