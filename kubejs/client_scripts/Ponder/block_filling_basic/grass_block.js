    ...
    .scene(
      ...
      (scene, utils) => {
        ...
        scene.world.modifyTileNBT([4, 5, 4], (nbt) => {
          nbt.TankContent = { Amount: 32000, FluidName: "minecraft:water" }
        })
        let Inputs = ["minecraft:dirt","minecraft:coarse_dirt"]
        let Outputs = ["minecraft:grass_block"]
