  ...
  event
    ...
    .scene(
      ...
      (scene, utils) => {
        ...
        scene.idle(40)
        scene.addKeyframe()
        scene.text(60, "在配方开始时会消耗25mB润滑油，同时加压蒸汽会被全部转化为水，并提供540 FE/t每格的电力，持续60 tick")
        scene.idle(20)
    ...
    .scene(
      "kubejs:superheated_steam_generator",
      "为蒸汽发电机填充过热蒸汽",
      "kubejs:9x9base",
      (scene, utils) => {
        function setBlock(block, pos) {
        ...
        scene.idle(20)
        scene.addKeyframe()
        scene.text(60, "除了加压蒸汽以外，为了配合协变热反应堆发电，蒸汽发电机还可以使用过热蒸汽！")
        setBlock("minecraft:iron_block", [3, 3, 4])
        scene.idle(5)
        setBlock("minecraft:gold_block", [4, 3, 4])
        scene.idle(5)
        ...
        scene.idle(25)
        scene.addKeyframe()
        scene.text(60, "同样的，你需要在发电机周围3*3内输入过热蒸汽，并为发电机提供每次配方25mB的润滑油")
        scene.overlay.showOutline("fast", {}, [3, 4, 4, 5, 6, 4], 60)
        scene.idle(20)
        scene.showControls(15, [4, 5, 4], "up").withItem("create:mechanical_pump")
        scene.showControls(15, [4, 6, 4], "left").withItem("kubejs:lube_oil_bucket")
        scene.idle(20)
        setBlock("kubejs:superheated_steam", [4, 4, 4])
        scene.idle(40)
        scene.addKeyframe()
        scene.text(60, "但与加压蒸汽配方不同的是，过热蒸汽会被完全消耗，并提供12000 FE/t每格的电力")
        scene.idle(20)
        setBlock("minecraft:air", [4, 4, 4])
        scene.idle(60)
        scene.addKeyframe()
        scene.text(60, "除以此外，过热蒸汽发电不会受到水的影响！")
        setBlock("kubejs:superheated_steam", [3, 4, 4])
        setBlock("minecraft:water", [4, 4, 4])
        scene.idle(30)
        setBlock("minecraft:air", [3, 4, 4])
        scene.text(30, "不受影响", [4, 5, 4])
        scene.idle(80)
      }
    )
})