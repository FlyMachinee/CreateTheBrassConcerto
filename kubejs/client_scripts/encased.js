...
PlayerEvents.tick(event => {
    ...
    let isCasing = Item.hasTag('dut_create:beltcasing')
    let isEncasable = viewBlock.hasTag('dut_create:encasable')
    let isUncasingable = viewBlock.hasTag('dut_create:uncasingable')
    if (!Client.isAltDown()) {
